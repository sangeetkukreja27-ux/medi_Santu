      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 border-b border-slate-800/80">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4 text-left">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            {/* X / Twitter */}
            <a href="#" className="w-8 h-8 rounded-lg bg-[#000000] hover:opacity-90 text-white flex items-center justify-center transition-all shadow-sm border border-slate-700" title="X">
            ...
            {/* Instagram */}
            <a href="#" className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF] hover:opacity-90 text-white flex items-center justify-center transition-all shadow-sm" title="Instagram">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
